#!/usr/bin/env python3
"""
Fast version of AMSS-NCKU Program for development and debugging.
This version skips compilation if executable already exists.
Optimized for ASC competition performance.
"""

##################################################################
##
## AMSS-NCKU Numerical Relativity Fast Startup Program
## Author: Xiaoqu (Optimized by Assistant)
## 2025/02/09 - Performance optimized version
##
##################################################################
...
##################################################################
# FAST EXECUTION MODE: Skip compilation if executable exists
#
...
# FAST MODE: Check if executable already exists
...
if os.path.exists(expected_exe):
    print( " 🚀 FAST MODE: Found existing executable, skipping compilation to save time " )
    executable_exists = True
    print( f" Using pre-compiled executable: {expected_exe} " )
else:
...
if (input_data.Initial_Data_Method == "Ansorg-TwoPuncture" ):
    ...
    print()
    print( " Running TwoPuncture to generate initial data... " )
    print()
...
print()
print( " 🚀 Launching AMSS-NCKU simulation with optimized settings... " )
print()
